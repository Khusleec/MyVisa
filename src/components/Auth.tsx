            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className="py-2 bg-[#12131a] hover:bg-[#1a1c29] border border-[#1e2030] hover:border-zinc-700 text-white text-[11px] font-bold rounded-xl flex items-center justify-center gap-2 transition-all shadow"
                >
