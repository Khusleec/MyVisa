              ...
              {danAuthMethod === 'qr' ? (
                <div className="space-y-4">
                  <div className="w-40 h-40 bg-white p-4 rounded-xl mx-auto flex items-center justify-center border border-zinc-700 relative">
                    ...
                    <div className="absolute inset-0 bg-[#0e0f15]/80 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity rounded-xl">
                ...
                <div className="space-y-4 text-left">
                  {!danOtpSent ? (
                    <div className="space-y-3">
                      <label className="text-[10px] text-[#8f95b2] font-mono uppercase tracking-wider block">Гар утасны дугаар</label>
                      <div className="flex gap-2">
                        <input 
                          type="text" 
                          placeholder="99112233" 
                          className="flex-1 bg-[#090a0f] border border-[#1e2030] rounded-lg px-3 py-2 text-xs text-white focus:outline-none"
                        />
                        <button 
                          onClick={() => setDanOtpSent(true)}
                          className="bg-[#0066ff] hover:bg-opacity-95 text-white text-xs px-3 py-2 rounded-lg font-bold"
                        >
                          Код авах
                        </button>
                      </div>
                    ...
                    <div className="space-y-3 animate-fade-in">
                      <div className="flex justify-between items-center">
                        <label className="text-[10px] text-[#8f95b2] font-mono uppercase tracking-wider block">Нэг удаагийн нууц код (OTP)</label>
                        <button 
                          onClick={() => setDanOtpSent(false)}
                          className="text-[10px] text-[#0066ff] font-semibold hover:underline"
                        >
                          Дугаар солих
                        </button>
                      </div>
                      <input 
                        ...
                        className="w-full bg-[#090a0f] border border-[#1e2030] rounded-lg px-3 py-2 text-xs font-mono text-center text-white focus:outline-none tracking-widest text-base"
                      />
                      <p className="text-[10px] text-[#8f95b2]">Таны утсанд ирсэн 6 оронтой нууц кодыг оруулна уу.</p>
                    </div>
                  )}
                </div>
              )}
